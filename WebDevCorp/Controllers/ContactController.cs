...
using WebDevCorp.ViewModels;

namespace WebDevCorp.Controllers
{
    public class ContactController : SurfaceController
    {
        ...
        public ActionResult HandleFormSubmit(ContactForm model)
        {
            ...
            message.To.Add("iamtestingumbraco@gmail.com");
            ...
            using (SmtpClient smtp = new SmtpClient())
            {
                ...
                smtp.Port = 587;
                smtp.Credentials = new System.Net.NetworkCredential("iamtestingumbraco@gmail.com", "umbracoumbraco!");
